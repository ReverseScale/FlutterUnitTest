...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/../../../zg_erp_flutter/.ios/Flutter/engine/Flutter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FlutterUnitTest/FlutterUnitTest.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ZGFlutterRouter/ZGFlutterRouter.framework"
  ...
  install_framework "${PODS_ROOT}/../../../zg_erp_flutter/.ios/Flutter/App.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zg_platform_channels/zg_platform_channels.framework"
fi
